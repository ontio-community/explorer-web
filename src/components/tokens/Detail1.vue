  ...
  <div class="detail-page">
    ...
    <div class="container">
      ...
      <div class="detail-content">
        ...
        <div class="item-content">
          <div class="m-item">
            <item-div :title="$t('tokens.detail.creator')" :singledata="tokenData.creator"></item-div>
          </div>
          <div class="m-item">
            <item-div
        ...
        <div class="item-content">
          ...
          <div class="m-item">
            <item-div :title="$t('tokens.detail.decimals')" :singledata="tokenData.decimals"></item-div>
          </div>
        </div>
        <div class="item-content">
          <div class="item">
            <item-div :title="$t('tokens.detail.vm_category')" :singledata="tokenData.vm_category"></item-div>
          </div>
        </div>
        <div class="item-content">
          <div class="m-item">
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(address,index) in holder.list" :key="index">
                ...
                <td @click="toAddressDetailPage(address.addressShow)">{{address.addressShow.substr(0,6) + '...' + address.addressShow.substr(28)}}</td>
...
export default {
  ...
  methods: {
    toPage($val) {
      console.log("tab1",$('#tab1').width())
      console.log($('#tab2').width())
      console.log($('#tab3').width())
      console.log($('#tab4').width())
      if ($val == "txns") {
        this.txnsFlag = true;
