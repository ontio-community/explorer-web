  ...
  <div class="mobile_nav">
    <el-collapse accordion>
      <el-collapse-item v-for="(item, index) in navData" :key="index">
        ...
        <div :class="item.isAbout ? 'nav_item isAbout': 'nav_item'" v-for="(ele, idx) in item.list" :key="idx">
          <div @click="gopageNav(ele)" class="mobile_link">{{ele.text}} <img v-if="ele.url.indexOf('dapp')>-1" class="nav-wailian-img" src="../../assets/images/common/wailian.svg" /> </div>
        </div>
      </el-collapse-item>
...
.mobile_nav {
  ...
  /deep/ .el-collapse-item__header {
    ...
    .el-icon-arrow-right:before {
      ...
      width: 12px;
      height: 12px;
      background: url(../../assets/images/common/open.svg);
